 ...
 * EeveCameraAccessory
 *
 * Implements the HomeKit Camera protocol (HAP) for the EEVE Mower's front camera.
 *
...
import { EeveMowerPlatform } from './platform';
...
export class EeveCameraAccessory implements CameraStreamingDelegate {
  ...
  constructor(
    private readonly platform: EeveMowerPlatform,
